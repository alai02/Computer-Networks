...
char *hostname = NULL;
char *file_path = NULL;
int buffer_size; //size of each chunk sent to the server
int file_size; //size of the file being sent to the server
...
// ./client server:123 -f filepath -b 12
// 0        1          2    3      4  5
...
int main(int argc, char *argv[])
{
	...
	char header_message[30];
	snprintf(header_message, 30, "%d-%d-%s", file_size, buffer_size, file_name);
